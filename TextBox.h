    ...
    void setSelected(bool sel) {
        ...
        if (!sel) {
            ...
            for (int i = 0; i < t.length(); i++) {
                newT += '*'; // Display asterisks instead of actual characters
            }
...
private:
    ...
    void deleteLastChar() {
        ...
        text.str("");
        text << newT;
        textbox.setString(text.str() + "_"); // Display asterisks
    }
    ...
    void inputLogic(int charTyped) {
        ...
        textbox.setString(std::string(text.str().length(), '*') + "_"); // Display asterisks
    }
};
